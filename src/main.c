...
int main(int argc, char *argv[])
{
    ...
    LLOG(LL_INFO, "RTZ_LOCAL_IP:SIGNAL_PORT,MEDIA_PORT,RTMP_PORT,MONITOR_PORT=%s:%d,%d,%d,%d",
         RTZ_LOCAL_IP, RTZ_LOCAL_SIGNAL_PORT, RTZ_LOCAL_MEDIA_PORT, RTMP_LOCAL_PORT, RTZ_MONITOR_PORT);
